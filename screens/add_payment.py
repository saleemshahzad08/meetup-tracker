...
class AddPaymentScreen(Screen):
    ...
    def _on_file_selected(self, selection):
        ...
        # result of the gallery/camera activity), not Kivy's main thread.
        # Updating widgets directly from here can silently fail to show
        # up on screen. Clock.schedule_once hands the work back to the
        # main thread, where it's safe to touch the UI.
