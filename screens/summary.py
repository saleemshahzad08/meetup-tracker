...
from utils.pdf_report import generate_pdf_report, get_report_filename
...
class SummaryScreen(Screen):
    ...
    def export_pdf(self):
        ...
        try:
            ...
            pdf_path = generate_pdf_report(payments, expenses, totals, output_path)
        except Exception as e:
