...
# python3 pinned to 3.11: an unpinned python3 let Buildozer pick 3.14,
# which is too new for pyjnius/pillow/reportlab's native builds to
# compile against yet. 3.11 is a stable, well-supported target.
requirements = python3==3.11.6,kivy,kivymd,plyer,pillow,pyjnius,sqlite3,reportlab
