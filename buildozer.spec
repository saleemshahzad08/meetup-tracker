...
# android.api bumped from 33 to 35: Android's Play Protect shows a
# "built for an older version of Android, doesn't have the latest
# protections" warning once your target API falls more than 2 versions
# behind the phone's own Android version. Targeting a recent API avoids
# that warning on current phones.
android.api = 35
android.minapi = 24
