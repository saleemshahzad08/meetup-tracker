...
# reportlab removed: its C-extension failed to compile across multiple
# build attempts. The PDF report was replaced with a Markdown report,
# which needs no external library at all.
requirements = python3==3.11.6,hostpython3==3.11.6,kivy,kivymd,plyer,pillow,pyjnius,sqlite3
